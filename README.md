...
This project represents the server-side component of the Window Kill game simulation, developed using Java Swing. This phase focuses on implementing the server to handle both online multiplayer and offline single-player gameplay. The server manages player connections, game state synchronization, and communication using TCP and UDP protocols.
